...
public class ATQiuZuLsitAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.tv_qiuzu_area=(TextView) convertView.findViewById(R.id.tv_qiuzu_area);
			holder.tv_qiuzu_jine=(TextView) convertView.findViewById(R.id.tv_qiuzu_jine);
			holder.tv_qiuzu_phone=(TextView) convertView.findViewById(R.id.tv_qiuzu_phone);
